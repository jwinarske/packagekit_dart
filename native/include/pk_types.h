...
template<> struct glz::meta<PkPackage> {
    static constexpr auto fields = std::make_tuple(
        glz::field("info",      &PkPackage::info),
...
template<> struct glz::meta<PkProgress> {
    static constexpr auto fields = std::make_tuple(
        glz::field("packageId",  &PkProgress::packageId),
        glz::field("status",     &PkProgress::status),
...
template<> struct glz::meta<PkDetails> {
    static constexpr auto fields = std::make_tuple(
        glz::field("packageId",   &PkDetails::packageId),
        glz::field("summary",     &PkDetails::summary),
        glz::field("description", &PkDetails::description),
        glz::field("url",         &PkDetails::url),
        glz::field("license",     &PkDetails::license),
        glz::field("group",       &PkDetails::group),
...
template<> struct glz::meta<PkUpdateDetail> {
    static constexpr auto fields = std::make_tuple(
        ...
        glz::field("state",       &PkUpdateDetail::state),
        glz::field("issued",      &PkUpdateDetail::issued),
...
template<> struct glz::meta<PkRepoDetail> {
    static constexpr auto fields = std::make_tuple(
        glz::field("repoId",      &PkRepoDetail::repoId),
...
template<> struct glz::meta<PkFiles> {
    static constexpr auto fields = std::make_tuple(
        glz::field("packageId", &PkFiles::packageId),
...
template<> struct glz::meta<PkErrorCode> {
    static constexpr auto fields = std::make_tuple(
        glz::field("code",    &PkErrorCode::code),
...
template<> struct glz::meta<PkMessage> {
    static constexpr auto fields = std::make_tuple(
        glz::field("type",    &PkMessage::type),
...
template<> struct glz::meta<PkEulaRequired> {
    static constexpr auto fields = std::make_tuple(
        glz::field("eulaId",           &PkEulaRequired::eulaId),
...
template<> struct glz::meta<PkRepoSigRequired> {
    static constexpr auto fields = std::make_tuple(
        glz::field("packageId",      &PkRepoSigRequired::packageId),
...
template<> struct glz::meta<PkRequireRestart> {
    static constexpr auto fields = std::make_tuple(
        glz::field("type",      &PkRequireRestart::type),
...
template<> struct glz::meta<PkManagerProps> {
    static constexpr auto fields = std::make_tuple(
        glz::field("backendName",       &PkManagerProps::backendName),
